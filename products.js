const productsList = [
  ...
  {
    id       : 'valeria-gommage-musk-atahara',
    name     : 'مقشر الجسم مسك الطهارة - ValeriA',
    brand    : 'Valeria · Soins',
    desc     : 'مقشر لطيف ومرطب للجسم برائحة مسك الطهارة من Valeria. يعمل على إزالة الخلايا الميتة وتنعيم البشرة لتتركها مشرقة ومنتعشة، ومناسب لجميع أنواع البشرة.',
    price    : 700,
    oldPrice : 900,
    img      : 'images/valeria_gommage.png',
    tag      : 'Bestseller',
    stars    : 5,
    category : 'soins',
    volume   : '250g',
    benefits : [
      "تقشير لطيف وفعال يزيل خلايا الجلد الميتة بعمق",
      "ترطيب فائق ونعومة حريرية للجسم تدوم طويلاً",
      "عطر مسك الطهارة المنعش والفاخر الذي يدوم طويلاً",
      "تركيبة طبيعية لطيفة ومناسبة لجميع أنواع البشرة"
    ]
  }
];
